...
export default function Home() {
  ...
  const fetchFoods = async() => {
    try {
      ...
      const foodReduced: IFoodReduced[] = data.map
      ((food: IFood) => ({
  ...
  return (
    ...
    {!isLoading ? (
      ...
      flex-col items-center justify-center p-6">
        ...
        mb-4">Welcome to <span 
        className="title_colored">NutriSpark</span></h1>
        <p className="text-lg mb-8 text-center max-w-2xl">Discover the nutritional value of your favorite food.
      ...
      items-center h-screen text-white">
